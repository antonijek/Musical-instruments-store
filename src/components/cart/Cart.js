  ...
  return (
    <>
      <Grid container sx={{width:'100%', height:'70vh',  marginTop:'5%'}}>
        <Grid item xs={12} sm={8} sx={{ height:'70vh', overflow:'auto', scrollbar:'5px', marginBottom:'20vh' }}>
          { addToCart.length ? (<Typography sx={{fontSize:'1.4em', textAlign:'center', color:'primary.main'}}>Your have {totalQuantity} items:</Typography>) : <Typography sx={{fontSize:'1.4em', textAlign:'center', color:'primary.main', mt:'30vh'}}>There is no instruments in card</Typography> }
        ...
        <Grid item xs={12} sm={4} sx={{}}>
          ...
          <Typography sx={{textAlign:'center', fontSize:'1.7em', marginBottom:'15%'}}>Balance: <b>{user.funds} &euro;</b></Typography>
